...
<head>
    ...
    <link rel="stylesheet" href="./css/ratchet.css" /><!-- Ratchet App CSS -->
    <link rel="stylesheet" href="./css/dropzone.css" />
    <link rel="stylesheet" href="./css/general.css" /><!-- come after to over-write Ratchet -->
    <link rel="stylesheet" href="./js/todc-select/select2.css" />
...
<body>
    ...
    <div class="notificationbar" data-bind="visible: allisvalid">
                        ...
                        <div class="user-login">
                            ...
                            <form class="content-padded">
                                <div class="input-group">
                                    <input type="email" data-bind="value: sidebarEmailAddress" placeholder="Email Address">
                                    <input type="password" data-bind="value: sidebarPassword" placeholder="Password">
                                </div>
        ...
        <div class="services">
            ...
            <div class="span6">
                ...
                <ul>
                    ...
                    <li>Book Report/Review, Movie Review</li>
                    <li>Coursework</li>
                    <li>Case Study</li>
                    <li>Lab Report</li>
            ...
            <div class="span6">
                <h3>Dissertation &amp; Thesis Services</h3>
                <ul>
                    <li>Dissertation</li>
                    <li>Any dissertation chapter</li>
                    <li>
                        <ul>
                            <li>Abstract</li>
                            <li>Introduction Chapter</li>
                    ...
                    <li>Thesis</li>
                    <li>Thesis/Dissertation Proposal</li>
            ...
            <div class="span6">
                ...
                <ul>
                    ...
                    <li>Math/Physics/Econ/Statistics Problems</li>
    ...
    <script type="text/x-handlebars" data-template-name="introduction">
        <div class="intro">
            <div class="intro-content">
                <h2>Hi, we are the new kids on the block!</h2>
                <p>...and we are happy to do any kind of writting for you.</p>
                <br />
    ...
    <script type="text/x-handlebars" data-template-name="about-us">
        <div class="introduction">
            <div class="padding">
                <h2>Will tell you who we are and why we are the best.</h2>
                <p>We are a company specializing in providing excellent writing services to people across the globe.</p>

                <p>Need an excellent writing service? then you are home. We have qualified and experienced team of writers who just cant wait to get a hand on your project. They are not only enthusiastic about custim writing but have the desire to give others knowledge and wisdom contained in the custom writing services.</p>

                <p>Why are we the best? because we care about you being the best in you school. Because of our intregrity, because of our character, assuring you of recieving non-plagiarized work in time, not delays, not a single second. And lastly because we are reasonable in our prices.</p>

                <p>Do you have a writing project? Make an order now.</p>
            </div>
        </div>
    </script>
    ...
    <div class="myorder">
        ...
        <input data-part="order" data-type="input" data-bind="value: title"
               id="ordertitle" type="text" placeholder="eg. Knight in Glaring Darkness">
        <table>
        <tr>
        <td>
            <div class="options">
                <h4>Type of Subject: </h4>
                <select data-part="order" data-type="select" name="subject area" id="subject" title="Subject area">
                    <optgroup label="Art">
            ...
            <div class="options">
                ...
                <select data-part="order" data-type="select" name="document" id="document" title="type of document">
            ...
            <div class="options">
                ...
                <select data-part="order" data-type="select" name="academic level" id="academiclvl">
            ...
            <div class="options">
                ...
                <select data-part="order" data-type="select" name="urgency" id="urgency" title="Paper urgency">
            ...
            <div class="options">
                ...
                <select data-part="order" data-type="select" name="writing_style" id="writtingstyle">
            ...
            <div class="options">
                <h4>Instructions</h4>
                <textarea id="instructions" data-part="order" data-type="textarea" rows="5"></textarea>
            </div>
        </td>
        <td>
            <div class="options">
                <h4>Prefered language: </h4>
                <select data-part="order" data-type="select" name="langstyle" id="langstyle">
                    <option value="English (U.S.)">English (U.S.)</option>
                    <option value="English (U.K.)">English (U.K.)</option>
                </select>
            </div>
            <div class="options">
                <h4>Total pages required or word:</h4>
                <input id="pgwdnumber" data-bind="value: pagesorwords" data-part="order" data-type="input" type="text" placeholder="eg. 12 or 2673">
            </div>
            <div class="options">
                <h4>Pages or words</h4>
                <select data-part="order" data-type="select" name="pages and words" id="pgorwords">
            ...
            <div class="options">
                ...
                <select data-part="order" data-type="select" name="currency" id="currency">
                    <option value="dollars">Dollars</option>
                    <option value="pounds">Sterling Pounds</option>
                </select>
            </div>
            <div class="options">
                <h4>Total:</h4>
                <div class="totalcost">
                    <h1><span id="key">$</span><span id="tcost">10.10</span></h1>
                </div>
                <br />
                <hr />
                <a id="submitAttach"
                   class="button-block button-positive">Upload Attachments &amp; Submit</a>
            </div>
        </td>
        </tr>
        </table>
    ...
    <script type="text/javascript" src="./js/libs/ember.min.js"></script>
    ...
    <script type="text/javascript" src="./js/todc-select/select2.min.js"></script>
