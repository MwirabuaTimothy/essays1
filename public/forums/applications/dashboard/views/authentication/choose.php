...
<div class="Info">
   ...
   <span class="PasswordForce"><?php echo sprintf(T('You can always use your password at<a href="%1$s">%1$s</a>.', 'If you are ever locked out of your forum you can always log in using your original BookCheetah email and password at <a href="%1$s">%1$s</a>'),Url('entry/password', TRUE)); ?></span>
</div>
