...
?>
<h1><?php echo T('&lt;Embed&gt; BookCheetah'); ?></h1>
<div class="Info">
   <?php echo T('BookCheetah can be embedded into your site in a variety of ways. Click the tabs below to find out more.'); ?>
</div>
...
<?php } else if ($this->EmbedType == 'forum') { ?>
   <h1><?php echo T('Embed your entire BookCheetah forum'); ?></h1>
   <div class="Info">
      <p><?php echo T('To embed your entire BookCheetah community forum into your web site, copy and paste this script into the page where you would like the forum to appear.'); ?></p>
...
<?php } else if ($this->EmbedType == 'modules') { ?>
   <h1><?php echo T('Embed modules from your BookCheetah forum into your site'); ?></h1>
   <div class="Info"></div>
   
<?php } else { ?>
<h1><?php echo T('Use BookCheetah as a commenting system in your site'); ?></h1>
<div class="Info">
